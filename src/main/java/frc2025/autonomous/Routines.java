...
public class Routines {
  ...
  public static Command testPath(RobotContainer container) {
    ...
    return new SequentialCommandGroup(
        ...
        currentSequence.getIndex(0), currentSequence.getIndex(1), currentSequence.getIndex(2));
  }
  ...
  public static Command processor_Side_Test(RobotContainer container) {
    ...
    return new SequentialCommandGroup(
        ...
        new ParallelRaceGroup(
            currentSequence.getIndex(0), setElevator(container, SuperstructureState.REEF_L4)),
  ...
  public static Command G_4N_5N_3N(RobotContainer container, PathSequence sequence) {
    ...
    return new SequentialCommandGroup(
        ...
        wristRollers
            ...
            .withTimeout(eject_TimeOut), // Score Coral
  ...
  public static Command _4N_5N_3N(RobotContainer container, PathSequence sequence) {
    ...
    return new SequentialCommandGroup(
        new ParallelRaceGroup(
            currentSequence.getNext(), setElevator(container, SuperstructureState.REEF_ALGAE_L1)),
        wristRollers
            .applyGoalCommand(WristRollersGoal.INTAKE)
            .withTimeout(intakeAlgae_TimeOut), // Algae 4 Grabbed
        setElevator(container, SuperstructureState.HOME),
        new ParallelRaceGroup(
            currentSequence.getNext(), setElevator(container, SuperstructureState.BARGE_NET)),
        wristRollers
            .applyGoalCommand(WristRollersGoal.EJECT_CORAL)
            .withTimeout(eject_TimeOut), // Algae 4 Scored
        setElevator(container, SuperstructureState.HOME),
        new ParallelRaceGroup(
            currentSequence.getNext(), setElevator(container, SuperstructureState.REEF_ALGAE_L2)),
        wristRollers
            .applyGoalCommand(WristRollersGoal.INTAKE)
            .withTimeout(intakeAlgae_TimeOut), // Algae 5 Grabbed
        setElevator(container, SuperstructureState.HOME),
        new ParallelRaceGroup(
                currentSequence.getNext(), setElevator(container, SuperstructureState.BARGE_NET))
            .andThen(
                wristRollers
                    ...
                    .withTimeout(eject_TimeOut) // Algae 5 Scored
                ),
        setElevator(container, SuperstructureState.HOME),
        new ParallelRaceGroup(
            currentSequence.getNext(), setElevator(container, SuperstructureState.REEF_ALGAE_L2)),
        wristRollers
            .applyGoalCommand(WristRollersGoal.INTAKE)
            .withTimeout(intakeAlgae_TimeOut), // Algae 3 Grabbed
        setElevator(container, SuperstructureState.HOME),
        new ParallelRaceGroup(
                currentSequence.getNext(), setElevator(container, SuperstructureState.BARGE_NET))
            .andThen(
                wristRollers
                    .applyGoalCommand(WristRollersGoal.EJECT_ALGAE)
                    .withTimeout(eject_TimeOut) // Algae 3 Scored
                ));
  }
