...
public class SwerveDrivetrain<
  ...
  public static class SwerveDriveState implements Cloneable {
    ...
    protected void updateFromJni(SwerveJNI.DriveState driveState) {
      if (Pose.getX() != driveState.PoseX
        ...
        Pose =
            new Pose2d(
                driveState.PoseX, driveState.PoseY, Rotation2d.fromRadians(driveState.PoseTheta));
      }
      ...
      if (Speeds.vxMetersPerSecond != driveState.SpeedsVx
        ...
        Speeds =
            new ChassisSpeeds(driveState.SpeedsVx, driveState.SpeedsVy, driveState.SpeedsOmega);
      }
  ...
  public class OdometryThread {
     ...
     *
     * @param priority Priority level to set the odometry thread to. This is a value between 0 and
  ...
  private SwerveDrivetrain(
    ...
    if (drivetrainConstants.Pigeon2Configs != null) {
      ...
      if (!retval.isOK()) {
        System.out.println(
            "Pigeon2 ID " + getPigeon2().getDeviceID() + " failed config with error: " + retval);
      }
    }
  ...
  public void setStateStdDevs(Matrix<N3, N1> stateStdDevs) {
    SwerveJNI.JNI_SetStateStdDevs(m_drivetrainId, stateStdDevs.getData());
  }
  ...
  /**
   * Get a reference to the full array of modules. The indexes correspond to the module described in
   * the constructor.
   *
